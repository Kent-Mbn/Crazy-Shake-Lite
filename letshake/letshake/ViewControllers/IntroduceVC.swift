...
class IntroduceVC: UIViewController, UIPageViewControllerDataSource {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.pageImageNames = NSArray(objects: MSS_NAME_IMAGE_INTRODEUCE_1, MSS_NAME_IMAGE_INTRODEUCE_2, MSS_NAME_IMAGE_INTRODEUCE_3, MSS_NAME_IMAGE_INTRODEUCE_4, MSS_NAME_IMAGE_INTRODEUCE_5, MSS_NAME_IMAGE_INTRODEUCE_6)
